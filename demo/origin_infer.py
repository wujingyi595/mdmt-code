...
def main():
    ...
    #                     help='config file')
    parser.add_argument('--config', default='./configs/mot/bytetrack/deform_bytetrack_full_mdmt.py',  #./configs/mot/bytetrack/one_carafe_bytetrack_full_mdmt.py
                        help='config file')

    parser.add_argument('--input', default='../mydev/home/wjy/MDMT/test/1/',
                        help='input video file or folder')

    parser.add_argument('--xml_dir', default='../mydev/home/wjy//MDMT/new_xml/',
    ...
    for dirrr in sorted(os.listdir(args.input)):
        ...
        if args.output and OUT_VIDEO:
            ...
            mmcv.frames2video(out_path + str(dirrr), args.output, fps=fps, fourcc='mp4v')
            mmcv.frames2video(out_path + str(dir2), args.output2, fps=fps, fourcc='mp4v')
            # out_dir.cleanup()
        # '''
