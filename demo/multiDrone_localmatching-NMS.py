...
import json
import time
from demo.utils.matching_pure12 import matching, calculate_cent_corner_pst
...
from utils.trans_matrix import local_compute_transf_matrix as compute_transf_matrix
...
def main():
    ...
    parser.add_argument('--result_dir', default='./json_resultfiles2/multiDrone_Localmatching-NMS',
...
#             track_bboxes, track_bboxes2, matched_ids, flag, coID_confirme = not_matched_supplement(A_old_not_matched_ids,
#                 A_old_not_matched_pts,
#                 A_old_not_matched_pts_corner,
#                 f1,
#                 cent_allclass2, track_bboxes,
...
#                 det_bboxes, det_bboxes2,
#                 image2, coID_confirme, thres=50)
#             track_bboxes2, track_bboxes, matched_ids, flag, coID_confirme = not_matched_supplement(
