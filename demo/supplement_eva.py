...
def main():
    ...
    #         mmcv.frames2video(out_path, outputname, fps=fps, fourcc='mp4v')
    #         mmcv.frames2video(out_path2, output2name, fps=fps, fourcc='mp4v')
    #         out_dir.cleanup()
    #     # '''
