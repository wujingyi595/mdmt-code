...
def inference_reid_mdmt(reid_model, img1, frame_id1, result1,img2,frame_id2,result2):
    # print("reid_model = ",reid_model)
    print("img1 = ",img1)
    print()
    # print("img2 = ",img2)
    # print("frame_id1 = ",frame_id1)
    # print("frame_id2 = ",frame_id2)
    print("result1 = ",result1)
    # print("result2 = ",result2)
    with torch.no_grad():
        result = reid_model.reid_mdmt(reid_model=reid_model,result1 = result1,result2 = result2)
    return result
def inference_reid_mdmt_com(reid_model, img1, frame_id1, result1,img2,frame_id2,result2):
    # print("reid_model = ",reid_model)
    print("img1 = ",img1)
    print()
    # print("img2 = ",img2)
    ...
    # print("result2 = ",result2)
    with torch.no_grad():
        result = reid_model.reid_mdmt_com(reid_model=reid_model,result1 = result1,result2 = result2)
    return result
...
# # def inference_mot(model, img, frame_id, bboxes1, ids1, labels1):
# #     """Inference image(s) with the mot model.
...
# #     # forward the model
# #     with torch.no_grad():
# #         result = model(return_loss=False, rescale=True, bil=dict(bboxes1=bboxes1, ids1=ids1, labels1=labels1), **data)
# #     return result
...
def inference_mot(model, img, frame_id, bboxes1, ids1, labels1, max_id):
    """Inference image(s) with the mot model.
    ...
    # forward the model
    with torch.no_grad():
        result = model(return_loss=False, rescale=True, frame_id=frame_id, bil=dict(bboxes1=bboxes1, ids1=ids1, labels1=labels1, max_id=max_id), **data)
    return result
